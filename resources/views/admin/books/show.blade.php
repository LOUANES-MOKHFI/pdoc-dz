            ...
            <div class="views-field views-field-addtocartlink">
                <div class="field-content">
                  <div class="add-to-cart">
                    ...
                    <a class="form-submit node-add-to-cart btn elevation-8dp text-center" style="background-color: #f23a2e;width:150px;color: white" href="{{url($book->adress_bib)}}" target="_blank">Télècharger</a>
                     @else
                     ...
                     @endif
                   <!--form action="/" accept-charset="UTF-8" method="post" id="uc-product-add-to-cart-form-3440">
                  <div>
                    <input type="hidden" name="qty" id="edit-qty" value="1">
                    <input type="submit" name="op" id="edit-submit-3440" value="Ajouter au panier" class="form-submit node-add-to-cart" style="background-color: #f23a2e; color: white">
                    <input type="hidden" name="form_build_id" id="form-h8rdpE3lY2FoHgHuFS8KAlhWfiJEN5LdMCfRAfbnKa0" value="form-h8rdpE3lY2FoHgHuFS8KAlhWfiJEN5LdMCfRAfbnKa0">
                    <input type="hidden" name="form_id" id="edit-uc-product-add-to-cart-form-3440" value="uc_product_add_to_cart_form_3440">
                  </div>
                  </form-->
                  </div>
                </div>
