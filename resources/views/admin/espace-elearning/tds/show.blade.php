    ...
    <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Afficher Le Cour <b>{{$tds->nom_cours}}</b></h3>
            </div>
            <div class="row">
              <div class="col-4">
                <h4>Nom De Tds :</h4>{{$tds->nom_td}}
                <h4>Année</h4>{{$tds->annee}}
                <h4>Module :</h4>{{module_tds($tds->id_module)->nom_module}}
                <h4>Domaine : </h4>{{module_tds($tds->id_module)->nom_domaine}}
              </div>
              <div class="col-4">
               <h4>Spécialite :</h4>{{module_tds($tds->id_module)->specialite}} 
               <h4>Niveaux :</h4>{{module_tds($tds->id_module)->niveaux}}
                <h4>Crée le :{{$tds->created_at}}</h4>
                </div>
            </div>
            <div class="col-12">
              <h4>
              <a href="{{ asset('Tds/'.$tds->td)}}" target="_blank" class=" elevation-8dp">Voir le fichier</a>
              </h4>
            </div>
    </div>
  </div>
