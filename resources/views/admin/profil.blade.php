        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{'/admin'}}">Profil</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="etablissement" required="" class="form-control">
                                        <option value="{{Auth::user()->universite}}">{{Auth::user()->universite}}</option>
                                ...
                                <div class="form-group">
                                    <label for="inputAddress2">Faculte</label>
                                    <input type="text" class="form-control" id="inputAddress2" placeholder="Votre Faculte" name="faculte" value="{{Auth::user()->faculte}}">
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">Domaine</label>
                                        <input type="text" class="form-control" id="inputCity" name="domaine" value="{{Auth::user()->domaine}}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputState">Specialite</label>
                                        <input type="text" class="form-control" id="inputCity" name="specialite" value="{{Auth::user()->specialite}}">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="inputZip">Matricule</label>
                                        <input type="text" class="form-control" id="inputZip" name="matricule" value="{{Auth::user()->matricule}}">
                                    </div>
                                </div>
