        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Foire aux Questions</h3>
              <a href="{{url('/admin/FAQ/create')}}" class="btn btn-info float-right"><i class="fas fa-plus"></i>Ajouetr une question</a>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$faq1->question}}</td>
                  <td>{{str_limit($faq1->reponse,100)}}</td>
                  <td>
                    <a class="btn btn-info fa fa-eye-slash" href="{{'/admin/FAQ/'.$faq1->id}}"></a>
                    <a class="btn btn-warning fa fa-btn fa-edit" href="{{'/admin/FAQ/'.$faq1->id.'/edit'}}"></a>
                        {{ csrf_field()}}
                        {{ method_field('DELETE') }}
                    <a class="btn btn-danger fas fa-times" href="{{'/admin/FAQ/'.$faq1->id.'/delete'}}"></a>
                  </td>
                </tr>
                 @endforeach
                </tbody>
