...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Liste des Reesources "Archive Ouvert"</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
             <div class="card-header row">
              <form class="card card-sm col-9" action="{{url('/search_ressource_AO')}}" method="get">
        {{ csrf_field()}}
         <div class=" row no-gutters align-items-center">
            ...
            <div class="col-auto">
             ...
             <div class="col-3">
                <a href="{{url('/admin/ressource/ressourceAO/create')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i>Ajouter une ressource</a>
             </div>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$ressource->organisme_producteur}}</td>
                  <td>{{$ressource->nationalite_ressource}}</td>
                  <td>
                     <a class="btn btn-info fa fa-eye-slash" href="{{'/admin/ressource/ressourceAO/'.$ressource->id}}"></a>
                      <a class="btn btn-warning fa fa-btn fa-edit" href="{{'/admin/ressource/ressourceAO/'.$ressource->id.'/edit'}}"></a>
                        {{ csrf_field()}}
                        {{ method_field('DELETE') }}
                        <a class="btn btn-danger far fa-trash-alt" href="{{'/admin/ressource/ressourceAO/'.$ressource->id.'/delete'}}"></a>
                  </td>
                </tr>
                @endforeach
                </tbody>
