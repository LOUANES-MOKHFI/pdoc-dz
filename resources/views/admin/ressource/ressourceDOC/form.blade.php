<form method="POST" action="{{url('admin/ressource/ressourceDOC') }}" enctype='multipart/form-data'>
                        @csrf
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="type_acces" class="form-control form-control-lg" required>
                                <option value="">--Type d'accées--</option>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="domaine_ressource" class="form-control form-control-lg" required>
                                <option value="">--Domaine de la ressource--</option>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control form-control-lg" name="langue" requied>
