...
<div class="custom-breadcrumns border-bottom" style="margin-top: 70px">
  <div class="container div">
    <a href="{{url('home')}}">Inscription</a>
     <span class="mx-3 icon-keyboard_arrow_right"></span>
     <span class="current">Abonement</span>
  </div>
</div>
<div class="body">
<div class="container-fluid">
    @if(Session::get('danger'))
    <div id="charge-error" class="text-center alert alert-danger {{!Session::has('danger')? 'hidden': ''}}">
        {{Session::get('danger')}}
    </div>
    @endif

  <form method="post" action="{{url('subscribe')}}" id="checkout-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                              <input class="gift-input" type="text" name="name" placeholder="Mark" value="{{$user->name}}"> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12"> <label class="gift">email</label><br> <input class="gift-input" type="email" name="email" placeholder="mark@mail.org" value="{{$user->email}}" > </div>
                                </div>
                                 <div class="row">
                            ...
                            <div class="form-card">
                                ...
                                <div class="row form-group">
                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                     <label> CVC</label>
                                     <input type="password" name="card-cvc" id="card-cvc" placeholder="&#9679;&#9679;&#9679;" class="placeicon" minlength="3" maxlength="4" required>
                                      </div>
                                </div>
                                {{csrf_field()}}
                                <!--div class="row form-group">
                                ...
                                <div class="" >
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-8">
                                         <input name="submit" type="submit" value="continue" class="btn btn-success">
                                        </div>
...
Stripe.setPublishableKey('pk_test_51GxJ9LLHBrLHzKL9xKUMo9BuRElquKuQzyj3KyfYDnH8rb8LfwxqZ4hFNowcZXTlWAUB0dAisxdFpR9dENMvPls8006bJILaja');
