...
<div id="about_bib" class="modal text-center">
   <div class="modal-content animate">
    <div class="imgcontainer">
      <span onclick="document.getElementById('about_bib').style.display='none'" class="close" title="Close Modal">&times;</span>
    </div>

    <div class="container" style="margin-top: 20px">
      <h2 class="text-center">A propos de BIBLIOGRAPHIE DES MODULES</h2>
