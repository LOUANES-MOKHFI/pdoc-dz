...
<div class="custom-breadcrumns" style="margin-top: 70px">
  <div class="container div">
    ...
    <span class="current">Ressources Algeriénnes </span>
  </div>
</div>
<div class="body">
    ...
    <div class="row search-header">
        <div class="col-lg-4 col-md-4 col-xs-12">
            ...
            <div class="vendor-text">
                Production Scientifique Des Universités Algeriénnes
            </div>
        </div>
        <div class="col-lg-8 col-md-8 col-xs-12">
            <div id="custom-search-input">
              <form action="{{url('/search_ressource_al')}}" method="get">
                  {{ csrf_field()}}
...
<a style="color:blue;" href="{{url('/ressource-ao/'.$lettre.'/Algériennes')}}">{{$lettre}}</a>
@endforeach
  ...
  <div class="row">
      ...
      <div class="container" style="margin-top: 20px">
        <div class="row alert alert-info text-center">
            <p>Aucune Ressource Algeriénne</p>
        </div>
      </div>
    @else
