...
<div class="wrap">               
  <div class="services_grid">
    <div class="container" style="margin-bottom: 20px">
      <h3 class="h3">Ajoute Un Td dans le Module <span style="color: red">{{$module->nom_module}}</span></h3>
      <div class="row container" >
           <form method="POST" action="{{ url('/add-tds') }}" enctype='multipart/form-data'>
                        @csrf
                        <div class="row">
                         <div class="col-md-6 form-group">
                            <label for="nom_cours">Nom de Td<span style="color: red"> *</span></label>
                            <input id="nom_td" type="text" class="form-control form-control-lg @error('nom_td') is-invalid @enderror" name="nom_td" value="{{ old('nom_td') }}" required autocomplete="nom_td">
                                @error('nom_td')
