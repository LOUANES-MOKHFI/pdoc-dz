    ...
    <div class="services">
      <h3>NAVIGATION</h3>
         ...
         <h4><i class="fas fa-university"></i><a href="{{url('etablissement')}}"> Etablissement</a></h4>
          ...
          <h5><i class="fas fa-folder"></i><a href="{{url('espace-elearning/cours')}}"> Cours</a></h5>
          <h5><i class="fas fa-folder"></i><a href="{{url('espace-elearning/tds')}}"> Tds</a></h5>
          <h5><i class="fas fa-folder"></i><a href="{{url('espace-elearning/examens')}}"> Examens</a></h5>
        </div>
    </div>
  </div>
</div> 
