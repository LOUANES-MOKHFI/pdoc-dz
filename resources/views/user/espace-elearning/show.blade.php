...
<div class="container" style="margin-bottom: 20px">
  @include('layouts.flash_msg')
    <h3 class="h3">Affiche le Module <span style="color: red">{{$module->nom_module}}</span></h3>

    <div class="row" >
       <div class="col-md-4 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="{{url('/module/'.$module->id.'/all-cours')}}">
                 ...
                 <div class="product-content">
                  @if(Auth::user()->genre == 'enseignant')
                    <h3 class="title a"><a class="btn btn-info" href="{{url('/module/'.$module->id.'/all-cours')}}">Les Cours</a></h3>
                    <h3 class="title a"><a class="btn btn-primary" href="{{url('/module/'.$module->id.'/add-cours')}}">Ajouter</a></h3>
                  @else
                    <h3 class="title b"><a href="{{url('/module/'.$module->id.'/all-cours')}}">Les Cours</a></h3>
                  @endif
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="{{url('/module/'.$module->id.'/all-tds')}}">
                     <img class="pic-1" src="/designe/images/folder.jpg">
                     <img class="pic-2" src="/designe/images/folder-open.jpg">
                    </a>
                 ...
                 <div class="product-content">
                  @if(Auth::user()->genre == 'enseignant')
                    <h3 class="title a"><a class="btn btn-info" href="{{url('/module/'.$module->id.'/all-tds')}}">Les Tds</a></h3>
                    <h3 class="title a"><a class="btn btn-primary" href="{{url('/module/'.$module->id.'/add-tds')}}">Ajouter</a></h3>
                  @else
                    <h3 class="title b"><a href="{{url('/module/'.$module->id.'/all-tds')}}">Les Td</a></h3>
                  @endif
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="{{url('/module/'.$module->id.'/all-examens')}}">
                     <img class="pic-1" src="/designe/images/folder.jpg">
                     <img class="pic-2" src="/designe/images/folder-open.jpg">
                    </a>
                ...
                <div class="product-content">
                  @if(Auth::user()->genre == 'enseignant')
                    <h3 class="title a"><a class="btn btn-info" href="{{url('/module/'.$module->id.'/all-examens')}}">Les examens</a></h3>
                    <h3 class="title a"><a class="btn btn-primary" href="{{url('/module/'.$module->id.'/add-examens')}}">Ajouter</a></h3>
                  @else
                    <h3 class="title b"><a href="{{url('/module/'.$module->id.'/all-examens')}}">Les examens</a></h3>
                  @endif
                </div>
            </div>
        </div>
