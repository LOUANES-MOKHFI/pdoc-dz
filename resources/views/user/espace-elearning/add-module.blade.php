...
<div class="wrap">               
  <div class="services_grid">
    <div class="container" style="margin-bottom: 20px">
      <h3 class="h3">Ajoute Un Module</h3>
      <div class="row container" >
           <form method="POST" action="{{ url('/add-module') }}">
                        ...
                        <div class="col-md-6 form-group">
                           ...
                           <input type="text" name="etablissement" class="form-control form-control-lg" id="etablissement" value="{{$etablissement}}" >
                        </div>
                        <input type="hidden" name="id_etablissement" value="{{$id}}">
                      </div> 
                    <div class="row">
                        <div class="col-12">
