    ...
    <div class="card">
      ...
      <div class="card-header row">
        ...
        <div class="col-md-4 col-sm-4 right">
          <h5 class="uppercase">{{count($documents)}} Documents partagée</h5>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          @elseif($document1->confirmation == 0)
                            ...
                            @endif
                           <a href="{{'/user/document/'.$document1->id}}" class="btn btn-info" style="width: 100px">modifier</a>
                         </td>
                    </tr>
                @endforeach
            <tbody>
