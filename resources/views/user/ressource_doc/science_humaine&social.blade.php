...
@section('content')
  ...
  <div class="custom-breadcrumns" style="margin-top: 70px">
      <div class="container div">
        ...
        <span class="current">Ressources SCIENCES HUMAINS ET SOCIALES </span>
      </div>
</div>
<div class="body">
    ...
    <div class="row search-header">
        <div class="col-lg-4 col-md-4 col-xs-12">
            <div class="vendor-logo">
                <h1>SCIENCES HUMAINS ET SOCIALES</h1>
            </div>
        ...
        <div class="col-lg-8 col-md-8 col-xs-12">
            <div id="custom-search-input">
              <form action="{{url('/search_ressource_shc')}}" method="get">
                  {{ csrf_field()}}
...
<a href="{{url('/ressource-doc/'.$lettre.'/SCIENCES HUMAINES ET SOCIALES')}}">{{$lettre}}</a>
@endforeach
 ...
 @if(count($ressourceDOC) == null)
      ...
      <div class="container" style="margin-top: 20px">
        <div class="row alert alert-info text-center">
            <p>Aucun  ressources SCIENCES HUMAINS ET SOCIALESE</p>
        </div>
      </div>
          ...
          <div class="menu-group-type-container">
            <ul id="menu-group-type" class="menu container">
              <li id="menu-item-1667" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1667">
                <a href="{{url('/ressources_shs/all_type')}}">Tous les Ressources</a></li>
             @foreach(all_typeshs() as $ressource)
              <li id="menu-item-1668" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1668"><a href="{{url('/ressources_shs/'.$ressource->type_ressource)}}">{{$ressource->type_ressource}}</a></li>
            @endforeach
            </ul>
        </div>
      </div>
